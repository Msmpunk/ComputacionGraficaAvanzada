...
glm::mat4 modelMatrixItem1 = glm::mat4(1.0f);
glm::mat4 modelMatrixItem2 = glm::mat4(1.0f);
...
void init(int width, int height, std::string strTitle, bool bFullScreen) {
	...
	modelHeliTra.loadModel("../models/Helicopter/Mi_24_heli_cola.obj");
	...
	modelItem1.loadModel("../models/Item1/Mask.obj");
	modelItem1.setShader(&shaderMulLighting);

	modelItem2.loadModel("../models/Item2/guitar.obj");
	modelItem2.setShader(&shaderMulLighting);
...
void applicationLoop() {
	...
	modelMatrixItem1 = glm::translate(modelMatrixItem1, glm::vec3(3.0, 1.0, -40.0));

	modelMatrixItem2 = glm::translate(modelMatrixItem2, glm::vec3(5.0, 0.0, -50.0));
	...
	while (psi) {
		...
		glBindTexture(GL_TEXTURE_2D, textureWallID);
		shaderMultiTextures.setInt("texture2", 3);
		glActiveTexture(GL_TEXTURE0);
		glBindTexture(GL_TEXTURE_2D, textureWindowID);
		shaderMultiTextures.setInt("texture1", 0);
		...
		glBindTexture(GL_TEXTURE_2D, textureSpongeID);
		modelItem1.render(modelMatrixItem1);
		glBindTexture(GL_TEXTURE_2D, textureWallID);
		modelItem2.render(modelMatrixItem2);

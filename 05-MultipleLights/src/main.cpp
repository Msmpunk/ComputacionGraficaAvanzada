...
std::vector<glm::vec3> lamp2Position = { glm::vec3(-36.52, 0, -23.24),
		glm::vec3(-52.73, 0, -3.90) , glm::vec3(-68.94, 0, 15.44), glm::vec3(-85.15, 0, 34.78) };
std::vector<float> lamp2Orientation = { 21.37 + 90, -65.0 + 90, -155.0 + 90, -245 + 90 };

/*std::vector<glm::vec3> lamp3Position = { glm::vec3(36.52, 0, -23.24),
		glm::vec3(52.73, 0, -3.90) , glm::vec3(68.94, 0, 15.44), glm::vec3(85.15, 0, 34.78) };
std::vector<float> lamp3Orientation = { -21.37 + 90, 65.0 + 90, 155.0 + 90, 245 + 90 };*/

std::vector<glm::vec3> lamp3Position = { glm::vec3(36.52, 0, -23.24),
		glm::vec3(52.73, 0, -3.90) };
std::vector<float> lamp3Orientation = { -21.37 + 90, 65.0 + 90 };
...
void init(int width, int height, std::string strTitle, bool bFullScreen) {
	...
	modelLamp3.loadModel("../models/Lampara/Lamp3.obj");
...
void applicationLoop() {
	...
	while (psi) {
		...
		glm::vec3 spotPosition2 = glm::vec3(modelMatrixLambo[3]);
		shaderMulLighting.setVectorFloat3("spotLights[0].light.ambient", glm::value_ptr(glm::vec3(0.2, 0.16, 0.01)));
		shaderMulLighting.setVectorFloat3("spotLights[0].light.diffuse", glm::value_ptr(glm::vec3(0.4, 0.32, 0.02)));
		//shaderMulLighting.setVectorFloat3("spotLights[0].light.specular", glm::value_ptr(glm::vec3(0.6, 0.6, 0.03)));
		shaderMulLighting.setVectorFloat3("spotLights[0].light.specular", glm::value_ptr(glm::vec3(1.0, 1.0, 0.06)));
		shaderMulLighting.setVectorFloat3("spotLights[0].position", glm::value_ptr(spotPosition2 + glm::vec3(0.6, 4.0, 7.0)));
		shaderMulLighting.setVectorFloat3("spotLights[0].direction", glm::value_ptr(glm::vec3(0, -1, 0)));
		shaderMulLighting.setFloat("spotLights[0].constant", 1.0);
		shaderMulLighting.setFloat("spotLights[0].linear", 0.02);
		shaderMulLighting.setFloat("spotLights[0].quadratic", 0.01);
		...
		shaderTerrain.setVectorFloat3("spotLights[0].light.diffuse", glm::value_ptr(glm::vec3(0.4, 0.32, 0.02)));
		//shaderTerrain.setVectorFloat3("spotLights[0].light.specular", glm::value_ptr(glm::vec3(0.6, 0.6, 0.03)));
		shaderTerrain.setVectorFloat3("spotLights[0].light.specular", glm::value_ptr(glm::vec3(1.0, 1.0, 0.06)));

		shaderTerrain.setVectorFloat3("spotLights[0].position", glm::value_ptr(spotPosition2 + glm::vec3(0.6, 4.0, 7.0)));
		shaderTerrain.setVectorFloat3("spotLights[0].direction", glm::value_ptr(glm::vec3(0, -1, 0)));
		shaderTerrain.setFloat("spotLights[0].constant", 1.0);
		shaderTerrain.setFloat("spotLights[0].linear", 0.02);
		shaderTerrain.setFloat("spotLights[0].quadratic", 0.01);
		...
		//Faro2
		glm::vec3 spotPosition3 = glm::vec3(modelMatrixLambo[3]);
		...
		//shaderMulLighting.setVectorFloat3("spotLights[0].light.specular", glm::value_ptr(glm::vec3(0.6, 0.6, 0.03)));
		shaderMulLighting.setVectorFloat3("spotLights[1].light.specular", glm::value_ptr(glm::vec3(1.0, 1.0, 0.06)));
		shaderMulLighting.setVectorFloat3("spotLights[1].position", glm::value_ptr(spotPosition3 + glm::vec3(-0.6, 4.0, 7.0)));
		...
		//shaderTerrain.setVectorFloat3("spotLights[0].light.specular", glm::value_ptr(glm::vec3(0.6, 0.6, 0.03)));
		shaderTerrain.setVectorFloat3("spotLights[1].light.specular", glm::value_ptr(glm::vec3(1.0, 1.0, 0.06)));

		shaderTerrain.setVectorFloat3("spotLights[1].position", glm::value_ptr(spotPosition3 + glm::vec3(-0.6, 4.0, 7.0)));
		...
		for (int i = 0; i < lamp2Position.size(); i++) {
			...
			shaderMulLighting.setVectorFloat3("pointLights[" + std::to_string(lamp1Position.size() + i)
				+ "].position", glm::value_ptr(lamp2Position));
		...
		for (int i = 0; i < lamp3Position.size(); i++) {
			...
			shaderMulLighting.setVectorFloat3("pointLights[" + std::to_string(i) + "].light.diffuse", glm::value_ptr(glm::vec3(0.4, 0.32, 0.02)));
			shaderMulLighting.setVectorFloat3("pointLights[" + std::to_string(i) + "].light.specular", glm::value_ptr(glm::vec3(0.6, 0.58, 0.03)));
			shaderMulLighting.setVectorFloat3("pointLights[" + std::to_string(i) + "].position", glm::value_ptr(lamp3Position));
			shaderMulLighting.setFloat("pointLights[" + std::to_string(i) + "].constant", 1.0);
			shaderMulLighting.setFloat("pointLights[" + std::to_string(i) + "].linear", 0.09);
			shaderMulLighting.setFloat("pointLights[" + std::to_string(i) + "].quadratic", 0.01);
			shaderTerrain.setVectorFloat3("pointLights[" + std::to_string(i) + "].light.ambient", glm::value_ptr(glm::vec3(0.2, 0.16, 0.01)));
			shaderTerrain.setVectorFloat3("pointLights[" + std::to_string(i) + "].light.diffuse", glm::value_ptr(glm::vec3(0.4, 0.32, 0.02)));
			shaderTerrain.setVectorFloat3("pointLights[" + std::to_string(i) + "].light.specular", glm::value_ptr(glm::vec3(0.6, 0.58, 0.03)));
			shaderTerrain.setVectorFloat3("pointLights[" + std::to_string(i) + "].position", glm::value_ptr(lamp3Position));
			shaderTerrain.setFloat("pointLights[" + std::to_string(i) + "].constant", 1.0);
			shaderTerrain.setFloat("pointLights[" + std::to_string(i) + "].linear", 0.09);
			shaderTerrain.setFloat("pointLights[" + std::to_string(i) + "].quadratic", 0.02);
...
int main(int argc, char** argv) {
	init(1366, 800, "Window GLFW", false);
	applicationLoop();
	destroy();
	return 1;
}
